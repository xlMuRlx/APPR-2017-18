...
=======
Prenesel sem podatke o uspešnosti držav na posameznih svetovnih prvenstvih ter njihovo učinkovitost iz uradne strani Mednarodne nogometne federacije (FIFA). Ker pa so bili podatki v pdf obliki, sem jih najprej pretvoril v excel datoteko. Nato sem podatke uvozil ter preuredil v obliko *tidy data*. Podobno sem storil tudi s podatki uvoženimi iz Wikipedije, pri katerih pa se je izkazalo, da potrebujem le en stolpec, ki sem ga tako dodal tabeli koncne.uvrstitve. Ti podatki so bili seveda podani v HTML obliki. Podatke imamo navedene v treh tabelah, ki so natančneje opisane spodaj. Na koncu opisa vsake tabele pa imamo podan še predogled izgleda same tabele.
>>>>>>> af18de83b48c5574a2bb0b74a1f911e048724792
